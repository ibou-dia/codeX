            ...
            >
              <div className="relative z-10">
                ...
                <p className="text-lg text-gray-700 mb-6 bg-white p-6 rounded-lg shadow-sm">
                  Nous sommes une équipe dynamique de 5 développeurs passionnés
                  par la création d&apos;expériences numériques innovantes et
                  percutantes.
                </p>
              ...
              >
                <div className="p-6 bg-gradient-to-r from-cyan-50 to-cyan-50 rounded-lg shadow-sm">
                  ...
                  <p className="text-lg text-gray-700">
                    Notre force réside dans notre diversité de compétences et
                    notre capacité à travailler ensemble pour relever les défis
              ...
              >
                <div className="p-6 bg-gradient-to-r from-cyan-50 to-cyan-50 rounded-lg shadow-sm">
                  ...
                  <p className="text-lg text-gray-700">
                    Participants enthousiastes à ce hackathon, nous sommes
                    déterminés à créer une solution qui fera la différence, en
                    combinant notre expertise technique et notre créativité.
                  </p>
                </div>
              </motion.div>
            </motion.div>
