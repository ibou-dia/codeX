...
const teamMembers = [
  {
    ...
    skills: ['UI/UX Design', 'Figma', 'React', 'React Native', 'JavaScript', 'Responsive Design'],
    projects: ['Dossier patient unique', 'Site de réservation d\'hotel', 'Système de reconnaissance de la langue des signes','Portfolio d\'équipe'],
...

  {
    ...
    projects: ['Cartographie des établissements d\'enseignement superieurs', 'App mobile pour les voyageurs du TER', 'Plateforme de mise en relation des entreprises', 'Site e-commerce'],
    github: 'https://github.com/',
    linkedin: 'https://linkedin.com/in/',
    ...
    skills: ['React', 'TypeScript', 'Flutter', 'Node.js', 'API Development', 'Mobile UX', 'Firebase'],
    projects: ['Gestion consommation d’énergie dans les ménages', 'Modernisation des services du CROUST', 'Plateforme d’apprentissage en sécurité informatique', 'App mobile de traduction en langues locales'],
    github: 'https://github.com/',
    linkedin: 'https://linkedin.com/in/',
...

  {
    ...
    projects: ['Système de detection de fraude', 'Assistant vocal interactif', 'Dashboard IA', 'Système d\'analyse de sentiments'],
