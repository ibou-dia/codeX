...
const teamMembers = [
  {
    ...
    projects: [
      ...
      "Site de réservation d'hotel",
      "Système de reconnaissance de la langue des signes",
      "Portfolio d'équipe",
    ],
    github: "https://github.com/abdoufatahgaye",
    linkedin: "https://www.linkedin.com/in/abdou-fatah-gaye-76a164327/",
    colorClass: "bg-gradient-to-br from-pink-500 to-rose-500",
    image: "/team/Fatah_.jpg",
  },

  {
    ...
    bio: "Amateur de développement backend, je construis des API robustes et des architectures serveur évolutives qui alimentent des applications performantes.",
    color: "from-green-500 to-teal-500",
    gradientText: "bg-gradient-to-r from-green-600 to-teal-500",
    skills: ["Django", "PHP", "REST API", "SQL", "Microservices"],
    projects: [
      "Cartographie des établissements d'enseignement superieurs",
      "App mobile pour les voyageurs du TER",
      "Plateforme de mise en relation des entreprises",
      "Site e-commerce",
    ],
    github: "https://github.com/xoss7",
    linkedin: "https://www.linkedin.com/in/amath-thiam-387b56371/",
  ...
  },
  {
    ...
    bio: "Passionné par le développement full stack avec une expertise particulière dans les applications mobiles. Je combine ma maîtrise du front-end et back-end pour créer des applications fluides et performantes. Ce qui me motive, c'est de transformer des concepts innovants en solutions technologiques qui ont un réel impact sur les utilisateurs.",
    ...
    projects: [
      "Gestion consommation d’énergie dans les ménages",
      "Modernisation des services du CROUST",
      "Plateforme d’apprentissage en sécurité informatique",
      "App mobile de traduction en langues locales",
    ],
    github: "https://github.com/faluhjaaw",
    linkedin: "http://linkedin.com/in/mamadou-falilou-diaw-4249a726b",
    colorClass: "bg-gradient-to-br from-blue-500 to-indigo-500",
    image: "/team/Falilou.jpg",
  },
  {
    id: 4,
    name: "Cheikh Tidiane TOURE",
    role: "Full Stack Developer",
    bio: "Développeur full stack passionné, je combine mes compétences en front-end et back-end pour concevoir des applications complètes, performantes et centrées sur l’utilisateur. J’accorde une importance particulière à la qualité du code, à l’expérience utilisateur et à l’impact concret des solutions que je développe.",
    color: "from-amber-500 to-orange-500",
    gradientText: "bg-gradient-to-r from-amber-600 to-orange-500",
    skills: ["Angular", "Java", "Jakarta EE", "Sprint Boot", "PostgreSQL"],
    projects: [
      "Site e-commerce",
    ...
    colorClass: "bg-gradient-to-r from-amber-600 to-orange-500",
...

  {
    ...
    bio: "Enthousiaste d'intelligence artificielle et d'analyse de données, je me spécialise dans la création d'algorithmes avancés pour extraire des insights précieux de données complexes. Ma passion est de développer des solutions innovantes alliant traitement du langage naturel et apprentissage automatique qui répondent à des problématiques business concrètes.",
    ...
    projects: [
      "Système de detection de fraude",
      "Chatbot avec les LLM",
      "Dashboard IA",
  ...
  return (
    <motion.div
      ...
      whileHover={{
        ...
        background:
          "linear-gradient(to right, rgb(238, 242, 255), rgb(240, 231, 255))",
          ...
          {teamMembers.map((member) => (
            ...
            >
              <div className="flex flex-col md:grid md:grid-cols-3 gap-0">
                <div
                  className={`relative h-80 md:h-auto bg-gradient-to-br ${member.color} flex items-center justify-center overflow-hidden`}
                >
                  {/* Cercles décoratifs */}
                  ...
                  >
                    <div
                      className={`w-40 h-40 md:w-56 md:h-56 rounded-lg shadow-lg overflow-hidden border-2 border-white/20`}
                    >
                      <GithubImage
                        src={member.image}
                ...
                <div
                  className="p-6 md:p-8 col-span-2 border-t-4 border-t-transparent"
                  style={{
                    borderTopColor: `var(--tw-gradient-stops)`
                      .split(",")[0]
                      .replace("--tw-gradient-from:", ""),
                  }}
                >
                  <div className="md:flex justify-between items-start mb-6">
                    <div className="hidden md:block">
                      ...
                      <p
                        className={`text-transparent bg-clip-text ${member.gradientText} font-medium`}
                      >
                        {member.role}
                      </p>
                    </div>
