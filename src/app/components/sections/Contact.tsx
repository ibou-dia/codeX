      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            Vous souhaitez en savoir plus sur nous ou discuter d&apos;une
            ...
            <div className="bg-white p-8 rounded-xl shadow-md">
              ...
              <div className="space-y-4 bg-blue-50 p-6 rounded-lg">
                ...
                <div className="text-sm text-gray-600">
                  <p>
                    Votre message sera envoyé à notre équipe et nous vous
                ...
                >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      } rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent outline-none transition-all text-gray-900 bg-white font-medium shadow-sm`}
                  ...
                  <motion.button
                    ...
                    className={`w-full px-5 py-3 bg-gradient-to-r from-cyan-600 to-blue-600 ${
                      !isSubmitting
